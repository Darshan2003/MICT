...
python3 /content/human-self-learning-anomaly/utils/input_C3D.py --root_video "$root_video" --root_frames "$root_frames" --root_C3D_dir "$root_C3D_dir" --root_features "$root_features" --csv_C3D "$csv_C3D"
...
python3 /content/human-self-learning-anomaly/utils/scores.py --csv_C3D "$csv_C3D" --root_frames "$root_frames" --model_dir "$model_dir" --norm_file "$norm_file"